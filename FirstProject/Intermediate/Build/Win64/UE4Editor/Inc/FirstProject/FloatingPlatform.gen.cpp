...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bInterp_MetaData[];
#endif
		static void NewProp_bInterp_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bInterp;
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed = { "InterpSpeed", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, InterpSpeed), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime = { "InterpTime", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, InterpTime), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp_MetaData[] = {
		{ "Category", "Platform" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
	};
#endif
	void Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp_SetBit(void* Obj)
	{
		((AFloatingPlatform*)Obj)->bInterp = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp = { "bInterp", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AFloatingPlatform), &Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloatingPlatform_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_bInterp,
	};
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 4095451338);
